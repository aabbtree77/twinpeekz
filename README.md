...
Another interesting case is [the choice of Go by Microsoft to implement the TypeScript compiler](https://github.com/microsoft/typescript-go/discussions/411). One would think what could be a better choice if not C# and esp. F# in this case, but Go's lack of proper sum types, immutability, type inference is outweighed by its better runtime.
